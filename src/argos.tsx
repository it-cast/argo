...
type SlideComponent = () => React.ReactElement;
...
export default function ARGOS() {
  ...
  useEffect(() => {
    const h = (e: KeyboardEvent) => {
      if (
        ['ArrowDown', 'ArrowRight', ' ', 'Enter', 'PageDown'].includes(e.key)
      ) {
        e.preventDefault();
        go(s + 1);
      }
      if (['ArrowUp', 'ArrowLeft', 'PageUp', 'Backspace'].includes(e.key)) {
        e.preventDefault();
        go(s - 1);
      }
      if (e.key === 'Home') {
  ...
  const ts = (e: React.TouchEvent<HTMLDivElement>) => {
...
.sl{width:100%;min-height:100vh;display:flex;flex-direction:column;justify-content:center;padding:36px 64px;position:relative;overflow:hidden;background:#FFFFFF}
...
/* helpers de layout */
const SL = ({ children, c }: { children: React.ReactNode; c?: boolean }) => (
  <div className={`sl${c ? ' c' : ''}`}>{children}</div>
);
  ...
  return (
    <SL c>
      ...
      <div style={{ maxWidth: 720, textAlign: 'center' }}>
        ...
        >
          Na antiguidade, existia um gigante chamado{' '}
          <span style={{ color: G2, fontWeight: 500 }}>Argos</span>, que tinha{' '}
          <span style={{ color: G2, fontWeight: 500 }}>cem olhos</span> e nunca
          dormia. Onde ele estava, nada passava despercebido.
        </P>
        <P
          mb={24}
          style={{
        ...
        >
          E a nossa{' '}
          <span style={{ color: G2, fontWeight: 500 }}>
            Inteligência Artificial
          </span>{' '}
          é o cérebro que une todos eles, garantindo que a informação certa
...
function Spoiler() {
  return (
    <SL c>
      ...
      >
        Qualquer órgão assume. Dois ou mais atuam juntos. Todos acompanham. O
        cidadão vê quem está cuidando.
      </P>
      <div
        style={{
          position: 'relative',
      ...
      >
        <div>
          ...
          <H2>
            Não é só um app.
            <br />
            <span style={{ color: PU }}>É a rede social da segurança.</span>
          </H2>
          <P mb={12}>
            Cada ocorrência vira um post no feed do bairro. Cidadãos comentam.
            Órgãos respondem publicamente. Quando o Bombeiro posta{' '}
            <em
              style={{
                color: I2,
                fontStyle: 'normal',
          ...
          >
            {[
              ...
              <div key={i}>
                ...
                <div style={{ fontSize: 12, color: I3 }}>{d}</div>
              </div>
            ))}
          </div>
        </div>
            ...
            {[
              {
                u: 'Maria S.',
                tp: '🔥 Incêndio',
                tx: 'Princípio de incêndio em terreno na Rua das Flores. Fumaça visível.',
                og: '🚒 Bombeiros assumiram',
                oc: RD,
                st: 'EM ATENDIMENTO',
                cm: {
                  f: '🚒 Bombeiros',
              ...
              },
              {
                u: 'Carlos R.',
                tp: '🚗 Acidente',
                tx: 'Colisão no cruzamento da Av. Principal. Trânsito parado.',
                og: '🚔 PM + 🚑 SAMU',
                oc: BL,
                st: '2 ÓRGÃOS',
                lk: 24,
...
function Dashboard() {
  return (
    <SL>
      <TAG>O Cérebro</TAG>
      <H2>
        Centro de comando com{' '}
        <span style={{ color: G2 }}>mapa de atendimento</span>
      </H2>
      <P mb={16}>
        Cada órgão monitora sua área com polígonos de abrangência, lista de
        ocorrências e alertas sonoros em tempo real.
      </P>
      <BOX style={{ padding: 12, boxShadow: SH2 }}>
        <div
          style={{
            display: 'flex',
            gap: 5,
        ...
        >
          ...
          >
            ...
            {[
              ...
              >
                ...
                >
                  <span style={{ fontSize: 8, color: I3 }}>{r.loc}</span>
                  <span
                    style={{
                      padding: '2px 6px',
                      borderRadius: 4,
          ...
          >
            ...
            <svg width="100%" height="100%" style={{ position: 'absolute' }}>
              <defs>
                <linearGradient id="pg" x1="0" y1="0" x2="1" y2="1">
                  <stop offset="0%" stopColor={BL2} stopOpacity="0.05" />
                  <stop offset="100%" stopColor="#6B9CF0" stopOpacity="0.02" />
                </linearGradient>
              </defs>
              <polygon
                points="50,30 350,18 395,185 325,260 65,235"
                fill="url(#pg)"
                stroke={BL2}
                strokeWidth={1.3}
                strokeDasharray="6 3"
            ...
            >
              <path
                d="M 0 140 Q 140 120 280 150 T 560 130"
                stroke={I}
                strokeWidth={3}
                fill="none"
              />
              <path
                d="M 230 0 Q 240 110 220 300"
                stroke={I}
                strokeWidth={2}
                fill="none"
              />
              <path
                d="M 90 0 Q 110 140 80 300"
                stroke={I}
                strokeWidth={1.2}
                fill="none"
              />
      ...
      >
        <div>
          ...
          <H2>
            Cada cidadão,
            <br />
            <span style={{ color: BL2 }}>um olho de Argos.</span>
          </H2>
          <P mb={20}>
            Em segundos, qualquer pessoa registra uma ocorrência com foto,
            descrição e GPS automático. O alerta é instantâneo.
          </P>
          <div
            style={{
              display: 'flex',
          ...
          >
            {[
              ['📷', 'Câmera integrada para registro visual'],
              ['📍', 'GPS automático com geocoding de bairro'],
              ['🔒', 'Denúncia anônima com sigilo total'],
              ['🏷️', '12 categorias de ocorrência urbana'],
              ['🏘️', 'Feed do bairro em tempo real'],
              ['💬', 'Comentários entre cidadãos e órgãos'],
            ].map(([ic, tx], i) => (
              <div
                key={i}
                style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {[
                  ...
                  <span
                    ...
                    style={{
                      padding: '3px 8px',
                      background: i === 0 ? `${BL}08` : BG,
                      border: `1px solid ${i === 0 ? `${BL}15` : BD}`,
                      borderRadius: 6,
                      fontSize: 9,
                      color: i === 0 ? BL : I3,
              ...
              >
                <span style={{ fontSize: 9, color: I4 }}>
      ...
      >
        <div>
          ...
          <H2>
            ...
            <br />
            para{' '}
            <span style={{ color: G2 }}>plataforma de cidade inteligente.</span>
          </H2>
          <P mb={20}>
            Argos começa como os olhos da cidade e evolui para o cérebro que
            conecta cidadãos, órgãos e inteligência artificial em uma rede sem
            precedentes.
          </P>
        </div>
        <div
          ...
          {[
            {
              ic: '🤖',
              t: 'IA para Triagem',
              d: 'Classificação automática de ocorrências por prioridade e tipo.',
            },
            {
              ic: '🗺️',
              t: 'Heatmap Público',
              d: 'Mapa anonimizado de incidentes por região para gestores e cidadãos.',
            },
            {
              ic: '🏆',
              t: 'Gamificação',
              d: "Pontos e badges. 'Olho de Argos do Mês.' Engajamento que escala.",
            },
            {
              ic: '📊',
            ...
            {
              ic: '🔗',
              t: 'Integração 190/193',
              d: 'API bidirecional com canais existentes. Zero duplicidade.',
            },
            {
              ic: '📡',
              t: 'IoT e Câmeras',
              d: 'Sensores e câmeras alimentam Argos automaticamente.',
            },
          ].map((x, i) => (
            <div
              key={i}
    ...
    <SL c>
        ...
        {[
          {
            n: '-70%',
            l: 'Tempo de Resposta',
            d: 'GPS + alertas instantâneos',
            c: BL2,
          },
          {
            n: '+300%',
            l: 'Volume de Registros',
            d: 'Mais acessível que ligações',
            c: GR,
          },
          {
            n: '100%',
            l: 'Rastreabilidade',
            d: 'Histórico completo auditável',
            c: G2,
          },
          {
            n: '24/7',
            l: 'Disponibilidade',
            d: 'Canal sempre aberto',
            c: PU,
          },
        ].map((x, i) => (
          <BOX
      ...
      >
        ...
        >
          ...
          >
            <span style={{ color: GR }}>✓</span> Dados geolocalizados para
            decisões estratégicas
            <br />
            <span style={{ color: GR }}>✓</span> Prestação de contas
            transparente e auditável
            <br />
            <span style={{ color: GR }}>✓</span> Coordenação multi-órgão sem
            precedentes
            <br />
            <span style={{ color: GR }}>✓</span> Redução de custos operacionais
          </div>
        </BOX>
        ...
        >
          ...
          >
            <span style={{ color: GR }}>✓</span> Voz direta e imediata para
            reportar
            <br />
            <span style={{ color: GR }}>✓</span> Acompanhamento transparente das
            resoluções
            <br />
            <span style={{ color: GR }}>✓</span> Rede social que fortalece a
            comunidade
            <br />
            <span style={{ color: GR }}>✓</span> Denúncia anônima protege quem
            reporta
          </div>
        </BOX>
      </div>
...
function Reveal() {
  return (
    <SL c>
      ...
      >
        A primeira rede social da segurança pública do Brasil. Cada cidadão é um
        olho. Cada órgão, um braço. A inteligência artificial, o cérebro.
        Juntos, uma rede que nunca dorme.
      </P>
    </SL>
  );
}
...
function Closing() {
  return (
    <SL c>
      ...
      >
        <a
          href="https://wa.me/5522999876929?text=Ol%C3%A1%2C%20gostaria%20de%20agendar%20uma%20demonstra%C3%A7%C3%A3o%20do%20Argos"
          target="_blank"
          ...
          style={{
            ...
            cursor: 'pointer',
            fontFamily: 'inherit',
            boxShadow: '0 6px 24px rgba(37,211,102,.2)',
            letterSpacing: 0.3,
            textDecoration: 'none',
            display: 'inline-flex',
            alignItems: 'center',
