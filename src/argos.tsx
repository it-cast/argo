...
export default function ARGOS() {
  ...
  return (
    <div
      ...
      onTouchEnd={te}
      style={{
        width: '100%',               // <<< evita “margem” horizontal do 100vw
        height: '100dvh',
        overflow: 'hidden',
        position: 'relative',
        background: '#FFFFFF',
...
html,body,#root{overflow:hidden;height:100dvh;width:100%;background:#fff}
...
/* ══ 1. SPOILER – linhas corrigidas ══ */
function Spoiler() {
  // mesmas coordenadas para SVG e para os cards, garantindo conexão perfeita
  const centerX = 280;
  const centerY = 150;

  const nodes = [
    { icon: '🚒', name: 'Bombeiros', x: 280, y: 34 },
    { icon: '🚔', name: 'Pol. Militar', x: 480, y: 80 },
    { icon: '🛡️', name: 'Defesa Civil', x: 480, y: 220 },
    { icon: '🔍', name: 'Pol. Civil', x: 80, y: 80 },
    { icon: '🏛️', name: 'Guarda Civil', x: 80, y: 220 }
  ];

  const toLeft = (x: number) => `${(x / 560) * 100}%`;
  const toTop = (y: number) => `${(y / 300) * 100}%`;
  ...
  return (
    <SL c>
      ...
      <P mb="clamp(20px,3vw,36px)" style={{ maxWidth: 520 }}>
      ...
      <div
        style={{
          ...
          maxWidth: '100%',
          aspectRatio: '56 / 30' // mantém proporção em qualquer tela
        }}
      >
        {/* Linhas saindo do centro para cada órgão */}
        <svg
          width="100%"
          height="100%"
          viewBox="0 0 560 300"
        ...
        {/* Cards dos órgãos – exatamente nas mesmas coordenadas das linhas */}
        {nodes.map((o, i) => (
          <div
            key={i}
            style={{
            ...
            {[
              {
                ...
                oc: RD,
                st: 'EM ATENDIMENTO',
                cm: { f: '🚒 Bombeiros', t: 'Equipe Alpha deslocada. ETA 4 min. Via Argos.' },
                lk: 12,
                co: 3,
                tm: '5 min'
              },
              ...
              <BOX key={i} style={{ padding: 13 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    ...
                    <div>
                      <div style={{ fontSize: 11, fontWeight: 600, color: I }}>{p.u}</div>
                      <div style={{ fontSize: 8, color: I4 }}>{p.tm} atrás</div>
                    </div>
                  </div>
                  <span
                    style={{
                ...
                {p.cm && (
                  ...
                  >
                    <div style={{ fontSize: 9, color: I2, lineHeight: 1.4 }}>
                      <span style={{ fontWeight: 700, color: p.oc, fontSize: 9 }}>{p.cm.f}:</span> {p.cm.t}
                    </div>
                  </div>
                )}
                <div style={{ display: 'flex', gap: 12, fontSize: 9, color: I3 }}>
                  <span>❤️ {p.lk}</span>
                  <span>💬 {p.co}</span>
                </div>
              </BOX>
...
function Dashboard() {
  return (
    <SL>
      <TAG>O Cérebro</TAG>
      <H2>
        Centro de comando com <span style={{ color: G2 }}>mapa de atendimento</span>
      </H2>
            ...
            {[
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <span style={{ fontSize: 9, fontWeight: 600, color: I }}>{r.t}</span>
                  <span style={{ fontSize: 8, color: I4, fontFamily: MO }}>{r.tm}</span>
                </div>
    ...
    <SL>
      ...
      >
        <div>
          ...
          <P mb={20}>
            Em segundos, qualquer pessoa registra uma ocorrência com foto, descrição e GPS automático. O alerta é
            instantâneo.
          </P>
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: 9, color: I2 }}>Sigilo ativo</span>
              </div>
      ...
      >
        <div>
          ...
          <P mb={20}>
            ...
            artificial em uma rede sem precedentes.
          </P>
        </div>
      ...
      >
        <BOX style={{ textAlign: 'left', padding: 16 }}>
          ...
          >
            ...
            <br />
            <span style={{ color: GR }}>✓</span> Prestação de contas transparente e auditável
            <br />
            <span style={{ color: GR }}>✓</span> Coordenação multi-órgão sem precedentes
            <br />
        ...
        <BOX style={{ textAlign: 'left', padding: 16 }}>
          ...
          >
            ...
            <br />
            <span style={{ color: GR }}>✓</span> Acompanhamento transparente das resoluções
            <br />
            <span style={{ color: GR }}>✓</span> Rede social que fortalece a comunidade
            <br />
            <span style={{ color: GR }}>✓</span> Denúncia anônima protege quem reporta
          </div>
        </BOX>
      </div>
    </SL>
  ...
  return (
    <SL c>
      ...
      >
        ...
        <em style={{ fontStyle: 'normal', color: G2, fontWeight: 600 }}>milhares</em>."
      </p>
